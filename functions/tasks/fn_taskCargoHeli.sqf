...
//random supply
_supplyneeded = selectRandom MIS_SlingloadCargo;
...
diag_log format ["%1",[_TaskID,_todeletearray,_loseTime,_destination,_supplyneeded,_funding]];
