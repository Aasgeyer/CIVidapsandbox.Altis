...
//_animationPool = ["Acts_AidlPercMstpSnonWnonDnon_warmup_1_loop","Acts_AidlPercMstpSnonWnonDnon_warmup_3_loop","Acts_AidlPercMstpSnonWnonDnon_warmup_8_loop"];
{
    ...
    _locmark = createMarker [format ["marker_%1_idaparea",_name],_safepos];
    _locmark setMarkerShapeLocal "ELLIPSE";
    _locmark setMarkerSizeLocal [_r,_r];
    _locmark setMarkerColorLocal "ColorWhite";
    _locmark setMarkerBrush "SolidBorder";
    _locmark = createMarker [format ["marker_%1_idap",_name],_safepos];
    _locmark setMarkerShapeLocal "ICON";
    _locmark setMarkerTypeLocal "flag_IDAP";
    _locmark setMarkerSize [0.5,0.5];
